...
rect_left_entry = tk.Entry(data_frame, bg=cfg.WHITE_COLOUR, font=("Consolas", 13),
                   fg=cfg.ADD_COLOUR, justify="center")
rect_right_entry = tk.Entry(data_frame, bg=cfg.WHITE_COLOUR, font=("Consolas", 13),
                   fg=cfg.ADD_COLOUR, justify="center")
rect_up_entry = tk.Entry(data_frame, bg=cfg.WHITE_COLOUR, font=("Consolas", 13),
                   fg=cfg.ADD_COLOUR, justify="center")
rect_down_entry = tk.Entry(data_frame, bg=cfg.WHITE_COLOUR, font=("Consolas", 13),
                   fg=cfg.ADD_COLOUR, justify="center")
x_entry = tk.Entry(data_frame, bg=cfg.WHITE_COLOUR, font=("Consolas", 13),
                   fg=cfg.ADD_COLOUR, justify="center")
y_entry = tk.Entry(data_frame, bg=cfg.WHITE_COLOUR, font=("Consolas", 13),
                   fg=cfg.ADD_COLOUR, justify="center")
...
info_btn = tk.Button(data_frame, text="Информация", font=("Consolas", 14),
                     ...
                     activebackground=cfg.ADD_COLOUR, activeforeground=cfg.MAIN_COLOUR)
rect_color_btn = tk.Button(data_frame, text="Установить цвет", font=("Consolas", 14),
                           bg=cfg.DEFAULT_COLOUR, fg=cfg.ADD_COLOUR, command=change_rect_color,
                           relief=tk.GROOVE)
sect_color_btn = tk.Button(data_frame, text="Установить цвет", font=("Consolas", 14),
                           bg=cfg.DEFAULT_COLOUR, fg=cfg.ADD_COLOUR, command=change_sect_color,
                           relief=tk.GROOVE)
res_color_btn = tk.Button(data_frame, text="Установить цвет", font=("Consolas", 14),
...
canvas = tk.Canvas(canvas_frame, bg="white", relief=tk.RAISED, borderwidth=2)
canvas.bind("<Button-1>", left_click)
root.bind("<Return>", return_click)
canvas.bind("<Button-2>", right_click)

canvas_frame.place(x=3 * cfg.BORDERS_WIDTH + cfg.DATA_WIDTH - 50, y=cfg.BORDERS_HEIGHT,
                   width=cfg.FIELD_WIDTH + 50, height=cfg.FIELD_HEIGHT)
